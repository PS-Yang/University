...
void draw_block(unsigned short, unsigned short);
void clear_block(unsigned short, unsigned short);
extern unsigned short new_row, new_col; 
int min,sec,ms;
/*************************************************************************
System TICK (TIMER0)
...
{
		TMOD = 0x00000003;
		//TDATA0 = 50000000; //0x2faf080;	//=50000000*20ns = 1sec		
		TDATA0 = 50000000/60; //1sec/60 -> 最小刻度
